...
const Card: FC<CardProps> = ({ imgSrc, title }) => {
  ...
  hover:bg-hoverSecondary flex-1 cursor-pointer h-[210px] xs:h-[290px] min-w-fit sm:min-w-[330px]
    max-w-[440px] rounded-2xl overflow-hidden transition-all duration-700 ease-linear"
    >
      <img
        src={imgSrc}
        alt=""
      ...
      transition-all duration-700 ease-in-out text-center w-full px-8 text-base sm:text-lg z-10 [tex-shadow:_0_4px_4px_rgb(0_0_0_/_50%)]"
      >
        {title}
      </p>
    </div>
